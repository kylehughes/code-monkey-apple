//
//  UIBezierPath+Super Headache.swift
//  Super Headache
//
//  Created by Kyle Hughes on 3/28/21.
//
...
extension UIBezierPath {
    ...
    public static func makeContinuouslyRoundedRectangle(for rect: CGRect, cornerRadius: CGFloat) -> UIBezierPath {
        makeContinuouslyRoundedRectangle(
            for: rect,
            cornerRadius: (
                cornerRadius,
                cornerRadius,
    ...
    public static func makeContinuouslyRoundedRectangle(
        for rect: CGRect,
        cornerRadius: (
            topLeft: CGFloat,
            topRight: CGFloat,
        ...
        let topRightP1 = CGPoint(
            x: rect.width - cornerRadius.topRight * ellipseCoefficient,
            y: rect.origin.y
        )
    ...
    private static func minimumCornerRadius(
        for rect: CGRect,
        cornerRadius: (
            topLeft: CGFloat,
            topRight: CGFloat,
        ...
        let minimumBottomRight = calculateMinimumRadius(
            w,
            h - (minimumTopRight * ellipseCoefficient),
            cornerRadius.bottomRight
        )
        let minimumBottomLeft = calculateMinimumRadius(
            w - (minimumBottomRight * ellipseCoefficient),
            h,
            cornerRadius.bottomLeft
        )
        let minimumTopLeft = calculateMinimumRadius(
            w - (minimumTopRight * ellipseCoefficient),
            h - (minimumBottomLeft * ellipseCoefficient),
